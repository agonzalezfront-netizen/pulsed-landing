import { zDiagRight, zWaveBottom, zColRight, zSphereLeft, zPlaneBottom, zDiagLeft, zSphereCenter } from '../lib/zones.js';
...
export const PULSED_SECTIONS = [
  ...
  { zone: zDiagLeft,     color: { base: '#fbbf24', bright: '#fde68a' }, bg: 'radial-gradient(ellipse 80% 70% at 15% 30%, #1a150a 0%, #050c1a 65%)' },
